...
const useStatistics = (player: Player, streamingServer: StreamingServer) => {
    ...
    return {
        ...
        // raw stream progress (0..1) from the streaming server, used by the
        // dead-torrent detector in Player.js
        streamProgress: typeof statistics?.streamProgress === 'number' ? statistics.streamProgress : 0,
    };
};
